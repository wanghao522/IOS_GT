...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  版本v1.0.1 仅供测试使用, 如有问题请联系 137471806@qq.com 
                  。。。。。。。。。。。。。。。。
                  。。。。。。。。。。。。。。。。
                   DESC

  s.homepage     = "https://github.com/wanghao522/IOS_GT"
  ...
  s.source       = { :git => "https://github.com/wanghao522/IOS_GT.git", :tag => "#{s.version}" }
  ...
  #
  s.vendored_frameworks = 'GT.framework'
  s.source_files  = "*.{h,m}"
  ...
  s.preserve_paths      = 'GT.framework/*', 'Resources/GT.bundle'
  ...
  s.frameworks = 'UIKit', 'CoreGraphics', 'Security', 'CoreTelephony', 'AdSupport', 'AudioToolbox', 'SystemConfiguration', 'QuartzCore'
